...
| **5** | Validation / errors | Validation in services/utils; global handler in `app.js` (400/401/403/404/409/500 as appropriate); generic **500** body; **`express-mongo-sanitize`**; **`helmet`**. |
